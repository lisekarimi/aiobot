# src/logger.py
"""Logger utilities for the AIObot application.

Note: This file is named logger.py (not logging.py) to avoid conflicts
...
def setup_logger(name: str = "aiobot", level: int = logging.INFO) -> logging.Logger:
